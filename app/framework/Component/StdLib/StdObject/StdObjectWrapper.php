...
class StdObjectWrapper extends AbstractStdObject
{
    ...
    public static function returnStdObject(&$var)
    {
        ...
        if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\AbstractStdObject')) {
            return $var;
        }
    ...
    public static function toArray($var)
    {
        if (self::isArray($var)) {
            ...
            if (self::isObject($var)) {
                if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\ArrayObject\ArrayObject')) {
                    return $var->val();
                }
            }
        }
    ...
    {
        if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\StringObject\StringObject')) {
            return true;
        }
    ...
    {
        if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\DateTimeObject\DateTimeObject')) {
            return true;
        }
    ...
    {
        if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\UrlObject\UrlObject')) {
            return true;
        }
    ...
    {
        if (self::isInstanceOf($var, 'app\framework\Component\StdLib\StdObject\FileObject\FileObject')) {
            return true;
        }
