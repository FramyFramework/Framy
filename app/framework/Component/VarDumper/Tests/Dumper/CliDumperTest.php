...
%A  options: []
  ...
  "obj" => app\framework\Component\VarDumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure(\$a, PDO &\$b = null) {#%d
    class: "app\framework\Component\VarDumper\Tests\Dumper\CliDumperTest"
    this: app\framework\Component\VarDumper\Tests\Dumper\CliDumperTest {#%d …}
  ...
  8 => &1 null
  "sobj" => app\framework\Component\VarDumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
EOTXT
    ...
    public function testThrowingCaster()
    {
        ...
        $this->assertStringMatchesFormat(
            <<<EOTXT
stream resource {@{$ref}
  ⚠: app\framework\Component\VarDumper\Exception\ThrowingCasterException {#%d
