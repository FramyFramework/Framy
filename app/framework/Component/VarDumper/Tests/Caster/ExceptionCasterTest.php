...
use app\framework\Component\VarDumper\Caster\ExceptionCaster;
use app\framework\Component\VarDumper\Caster\FrameStub;
...
Exception {
  ...
  trace: {
    ...
    app\framework\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testDefaultSettings() {}
%A
EODUMP;
        ...
        $expectedDump = <<<'EODUMP'
{
  ...
  app\framework\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testSeek() {}
%A
EODUMP;
...
Exception {
  ...
  trace: {
    ...
    app\framework\Component\VarDumper\Tests\Caster\ExceptionCasterTest->testNoArgs() {}
%A
EODUMP;
