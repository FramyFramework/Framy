...
use app\framework\Component\VarDumper\Caster\ArgsStub;
use app\framework\Component\VarDumper\Caster\ClassStub;
use app\framework\Component\VarDumper\Caster\LinkStub;
...
use app\framework\Component\VarDumper\Tests\Fixtures\FooInterface;
...
<foo></foo><bar><span class=sf-dump-note>array:1</span> [<samp>
  <span class=sf-dump-index>0</span> => "<a href="%sStubCasterTest.php:0" rel="noopener noreferrer"><span class=sf-dump-str title="55 characters">app\framework\Component\VarDumper\Tests\Caster\StubCasterTest</span></a>"
</samp>]
</bar>
EODUMP;
...
EODUMP;
    ...
    public function testClassStubWithNotExistingClass()
    {
        ...
        $expectedDump = <<<'EODUMP'
<foo></foo><bar><span class=sf-dump-note>array:1</span> [<samp>
  <span class=sf-dump-index>0</span> => "<span class=sf-dump-str title="app\framework\Component\VarDumper\Tests\Caster\NotExisting
52 characters"><span class="sf-dump-ellipsis sf-dump-ellipsis-class">app\framework\Component\VarDumper\Tests\Caster</span><span class=sf-dump-ellipsis>\</span>NotExisting</span>"
</samp>]
</bar>
EODUMP;
