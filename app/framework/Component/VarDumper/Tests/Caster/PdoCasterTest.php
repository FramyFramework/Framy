...
use app\framework\Component\VarDumper\Caster\PdoCaster;
...
class PdoCasterTest extends TestCase
{
    ...
    public function testCastPdo()
    {
        ...
        $this->assertInstanceOf('app\framework\Component\VarDumper\Caster\EnumStub', $cast["\0~\0attributes"]);

        $attr = $cast["\0~\0attributes"] = $cast["\0~\0attributes"]->value;
        $this->assertInstanceOf('app\framework\Component\VarDumper\Caster\ConstStub', $attr['CASE']);
